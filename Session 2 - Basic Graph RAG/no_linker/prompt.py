...
Donot add the backticks in the final query, it is just for explaination.
Schema:
{schema}
Note: Be as concise as possible.
Do not include any explanations or apologies in your responses.
Do not respond to any questions that ask for anything else than for you to construct a SPARQL query.
Do not include any text except the SPARQL query generated and also please ensure that the syntax is correct as ab
